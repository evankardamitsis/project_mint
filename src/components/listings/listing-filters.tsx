      ...
      <form action="/browse" method="get" className="w-full">
        ...
        <div className="relative w-full">
          ...
          <input
            ...
            className="h-11 w-full border-[1.5px] border-[#111111] bg-[#ffffff] pl-11 pr-[14px] text-[13px] text-[#111111] outline-none placeholder:text-[#999999]"
          />
        </div>
      </form>

      <ListingFilterChips categories={categories} brands={brands} values={values} labels={filterLabels} />
    </div>
  );
}
